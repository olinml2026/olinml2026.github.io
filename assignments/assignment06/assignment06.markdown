...
This builds on:
* [Supervised learning problem framing](/assignments/assignment02/assignment02?
  showAllSolutions=true#supervised-learning-problem-setup).
* Calculating gradients.
* [Log loss](/assignments/assignment05/assignment05?showAllSolutions=true#probability-and-the-log-loss)
